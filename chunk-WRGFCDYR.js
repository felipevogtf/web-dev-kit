import{a as R,b as $}from"./chunk-22FBWMF6.js";import{b as N}from"./chunk-VLYKAATE.js";import{c as k,d as F,e as z,f as D,h as v,i as J}from"./chunk-6IE7XVRO.js";import{$ as g,C as p,D as m,E as H,J as u,K as L,L as M,M as O,N as P,R as r,S as s,T as l,X as b,ca as E,f as y,g as C,ia as f,ka as S,l as x,o as T,oa as I,q as h,r as w,z as j}from"./chunk-VAZFKGSO.js";var _=(()=>{let t=class t{constructor(e){this.library=e,this.library.addIcons(J)}};t.\u0275fac=function(i){return new(i||t)(m(D))},t.\u0275cmp=h({type:t,selectors:[["html-viewer"]],inputs:{html:"html",width:"width",height:"height"},standalone:!0,features:[E],decls:1,vars:5,consts:[[1,"html-viewer",3,"innerHTML"]],template:function(i,o){i&1&&l(0,"div",0),i&2&&(L("width",o.width)("height",o.height),u("innerHTML",o.html,j))},dependencies:[f,v],styles:[".html-viewer[_ngcontent-%COMP%]{padding:15px;border:solid 1px var(--border-color);border-radius:var(--base-radius);overflow:auto}"]});let n=t;return n})();function W(n,t){n&1&&(r(0,"span",12),l(1,"i",13),s())}var V=(()=>{let t=class t{constructor(e,i){this.sanitizer=e,this.changeDetectorRef=i,this.editorOptions={theme:"vs-dark",language:"javascript",fontSize:"16px",lineHeight:"21px",fontFamily:"Cascadia Code, system-ui",fontLigatures:!0},this.code="",this.output="",this.outputHTML="",this.loading=!0,this.running=!1,this.codeEvent=new C;let o=console.log,c=console.error,d=console.warn;console.log=(...a)=>{this.output+=this.logToHTML(a.join(" "))+`
